...
function chg() {
	...
	txt=txt+"&V5=";
	if (V5.checked==true) {txt=txt+"100";} else {txt=txt+"0"}
	txt=txt+"&V6=";
	if (V6.checked==true) {txt=txt+"100";} else {txt=txt+"0"}
	window.location=txt;
}
</script>
<%
...
row_max=0
rs.Open "SELECT COUNT(ID) FROM vent_log",conn
row_max=rs.Fields(0)
rs.Close
...
<thead><tr>
<th>Time</th>
<th align="center">VENT1</th>
<th align="center">VENT2</th>
<th align="center">VENT3</th>
<th align="center">VENT4</th>
<th align="center">VENT5</th>
<th align="center">VENT6</th>
</tr>
<%If pg=1 Then%>
<tr>
<th>&nbsp</th>
...
<div class="iphone-toggle-buttons">
<label for="V5">
<input type="checkbox" name="V5" id="V5" onchange="chg()" <%If rs.Fields(6).value=100 Then%>checked="checked"<%End If%> />
<span>checkbox 0</span>
</label>
</div>
</th> 
...
<div class="iphone-toggle-buttons">
<label for="V6">
<input type="checkbox" name="V6" id="V6" onchange="chg()" <%If rs.Fields(7).value=100 Then%>checked="checked"<%End If%> />
<span>checkbox 0</span>
</label>
</div>
</th> 
...
If pg > 1 Then%>
<a href="admin.asp?submenu=vent&page=
<%
=pg-1
%>
