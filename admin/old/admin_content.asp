...
''Response.Write("&nbsp&nbsp&nbsp!"+submenu+"!")

If menu="sensors" And submenu="TH" Then
Response.Redirect("http://localhost/admin/log/th_show.asp")
%>
<script>
parent.content.location.replace('http://localhost/admin/log/th_show.asp')
</script>
<%
End If
...
%>
<script>
parent.content.location.replace('http://localhost/admin/log/light_show.asp')
</script>
<%
End If
